...
const Home = () => {
  ...
  const ai = new GoogleGenAI({
    apiKey: "AQ.Ab8RN6IOdyBmSIT2__eN30bn_eHeWCwrbZgyTLxwri-6yV3oOw"
  });
...
<div className="w-full py-6 rounded-xl bg-[var(--secondary-bg)] mt-5 p-5">
              ...
              option: (base, state) => ({
                ...
                backgroundColor: state.isSelected
                  ...
                  : state.isFocused
                    ...
                    : "var(--primary-bg)",
                color: "var(--text-color)",
                "&:active": { backgroundColor: "var(--hover-bg)" }
              }),
          ...
          <textarea
            ...
            value={prompt}
            className='w-full min-h-[200px] rounded-xl bg-[var(--primary-bg)] mt-3 p-3 text-[var(--text-color)] placeholder-gray-400 outline-none focus:ring-2 focus:ring-purple-500 resize-none'
              ...
              <>
                ...
                <div className="bg-[var(--tertiary-bg)] w-full h-[50px] flex items-center justify-between px-4">
                  ...
                  <div className="flex items-center gap-2">
                    {tab === 1 ? (
                      <>
                        <button onClick={copyCode} className="w-10 h-10 rounded-xl border border-zinc-800 flex items-center justify-center hover:bg-[var(--hover-bg)]"><IoCopy /></button>
                        <button onClick={downnloadFile} className="w-10 h-10 rounded-xl border border-zinc-800 flex items-center justify-center hover:bg-[var(--hover-bg)]"><PiExportBold /></button>
                      </>
                    ) : (
                      <>
                        <button onClick={() => setIsNewTabOpen(true)} className="w-10 h-10 rounded-xl border border-zinc-800 flex items-center justify-center hover:bg-[var(--hover-bg)]"><ImNewTab /></button>
                        <button onClick={() => setRefreshKey(prev => prev + 1)} className="w-10 h-10 rounded-xl border border-zinc-800 flex items-center justify-center hover:bg-[var(--hover-bg)]"><FiRefreshCcw /></button>
                      </>
                    )}
                  </div>
                </div>
